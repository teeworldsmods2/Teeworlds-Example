...
MACRO_CONFIG_INT(SvMaxClients, sv_max_clients, 56, 1, MAX_CLIENTS, CFGFLAG_SERVER, "Maximum number of clients that are allowed on a server")
MACRO_CONFIG_INT(SvMaxClientsPerIP, sv_max_clients_per_ip, 4, 1, MAX_NOBOT, CFGFLAG_SERVER, "Maximum number of clients with the same IP that can connect to the server")
